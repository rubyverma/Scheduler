...
<link href="/Scheduler/resources/css/carousel.css" rel="stylesheet">
</head>
<!-- NAVBAR
================================================== -->
<body>
			...
			<div class="item active">
				...
				<div class="container">
					<div class="carousel-caption">
						<h1>
							<code>Schedule your appointments with SchedulerApp!</code>
						</h1>
						<p>Note: If you're viewing this page via a file URL, the
							"next" and "previous" Glyphicon buttons on the left and right
							might not load/display properly due to web browser security
							rules.</p>
						<p>
							<a class="btn btn-lg btn-primary" href="client/register"
	...
	<div class="container marketing">
		...
		<footer>
			...
			<p>
				&copy; 2013 Scheduler, Inc. &middot; <a href="#">Privacy</a>
