...
<td width=150%></td>
<td>
<div class="pull-right slient"> <button class="btn btn-primary" data-toggle="modal" data-target="#addCategory">Add Category</button></div>
</td>
<td>
<div class="pull-right slient"><button class="btn btn-primary" data-toggle="modal" data-target="#addFaq">Add FAQ</button></div>
</td>
</table>
...
<c:forEach items="${categories}" var="category">
	...
	<div class="panel panel-primary">
		<div class ="panel-heading">
		    ...
		    <a href="/Scheduler/category/edit/${category.categoryId}" class="label label-warning">Update</a>
		    <a href="/Scheduler/category/delete/${category.categoryId}" class="label label-danger">Delete</a>
	      </div>
		</div>
				...
				<c:forEach items="${category.faqs}" var="faq">
					<div class="panel panel-success">
						<div class ="panel-heading">
							...
							<div class="pull-right silent"><a href="/Scheduler/faq/edit/${faq.faqId}" class="label label-warning">Update</a></div>
	   						<div class="pull-right silent"><a href="/Scheduler/faq/delete/${faq.faqId}" class="label label-danger">Delete</a></div>
						</div>
						<div class ="panel-body">
							<table>
								<tr>
	...
	<div class ="panel-body">
		Please delete this category as it is not being used.
	</div>
	</div>
	</c:if>
</c:forEach>
